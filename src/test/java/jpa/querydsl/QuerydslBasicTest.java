...
//
    ...
    public void complexCase() throws Exception {
        List<String> result = queryFactory
                .select(new CaseBuilder()
                        ...
                        .when(member.age.between(21, 20)).then("20~30살")
                        .otherwise("기타"))
                .from(member)
                .fetch();
    ...
    public void findDtoByJPQL() throws Exception {
        List<MemberDto> resultList = em.createQuery("select new jpa.querydsl.dto.MemberDto(m.username, m.age) " +
    ...
    // subQuery 값 가져오기 (ExpressionUtils로 감싸기)
    @Test
...
//                .where(usernameEq(usernameCond), ageEq(ageCond))
    ...
    public void bulkUpdate() throws Exception {
        ...
        // 아래와 같이 영속성 컨텍스트에 그대로 남아있기 때문에 flush, clear처리
        em.flush();
        em.clear();
